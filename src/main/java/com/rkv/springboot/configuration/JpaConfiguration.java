package com.rkv.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.rkv.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.rkv.springboot.model" });
